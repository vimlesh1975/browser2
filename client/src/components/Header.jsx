...
export const Header = () => {
    ...
    const logout = () => {
        ...
        window.location.href = 'http://ndms2.pbns.in/pbns/dmam/home/index.php';
    }
    const selectBg = e => {
    ...
    return (
        <>
            ...
            <nav onDoubleClick={showAndSelectColor} className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: bg }}>
                <div style={{ width: '100%' }}>
                    <button type="button" className="btn btn-warning btn-sm  mr-1"><a href="http://ndms2.pbns.in/pbns/dmam/home/index.php">HOME</a></button>
